<?php
   ...
   $sql = 'SELECT id, roll, question, id_relation, created_at  FROM questionaire';
...
<body>
   ...
   <?php
      ...
      echo "<table>";
         echo "<thead>";
            echo "<tr>";
               echo "<th width ='8%'>S.No.</th><th>Lecturer</th><th width='30%'>Question</th><th>Student</th>
      ...
      echo "<table>";
         while ($row = mysql_fetch_array($retval, MYSQL_ASSOC) ) {
            ...
            echo "<td width ='30%'>".$row['question']."</td>";
            echo "<td>".$row['roll']."</td>";
